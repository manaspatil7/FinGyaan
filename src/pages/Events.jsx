...
//   // Filter events based on the search term and selected location
...
//     const matchesLocation = selectedLocation ? event.location.toLowerCase().includes(selectedLocation.toLowerCase()) : true;
...
//     <div className="p-6">
//       <ToastContainer />
//       <h1 className="text-3xl font-bold text-center mb-6 text-gray-800">Upcoming Finance Events</h1>
...
//           <div key={event.id} className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 group">
//             <img
//               src={event.image}
//               alt={event.name}
...
//                 className="mt-4 w-full p-2 bg-blue-500 text-white font-bold rounded-md transition-all duration-300 group-hover:brightness-110 hover:animate-pulse"
//               >
//                 Register
//               </button>
//             </div>
